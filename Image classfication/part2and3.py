...
def get_images(path, size, Normalize=0):
    total_pic = {}
    labels = []
...
train, train_digit_labels = get_images('./hw5_data/train/', 256)
test, test_digit_labels = get_images('./hw5_data/test/', 256)
...
a = nearest_neighbor_classify(bovw_train, train_labels, bovw_test)
